...
function Rsignup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try{
            const response = await axios.post('/api/R/signup' , {name , email , password} , { withCredentials: true });
  ...
  <h1 className="text-center text-5xl text-purple-200 mb-8">Recruiter | Signup Form</h1>
  ...
  <form className="flex flex-col w-full" onSubmit={handleSubmit}>
    <label className="block mb-2 text-3xl text-purple-200" htmlFor="Name">
      Name
    </label>
    <input
      name="name"
